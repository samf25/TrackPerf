...
TrackPerfParquet::TrackPerfParquet()
  : LCParquetBase("TrackPerfParquet")
{  
  // modify processor description
  _description = "TrackPerfParquet creates a Parquet file suitable for tracking performance studies" ;
